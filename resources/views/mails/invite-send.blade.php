                ...
                <td align="center" valign="top" id="bodyCell">
                    ...
                    <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" width="500"
                        ...
                        <tr>
                            <td align="center" valign="top">
                                <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                    style="color:#FFFFFF;" bgcolor="#0275d8">
                                    <tr>
                                        <td align="center" valign="top">
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top"
                                                                    ...
                                                                    <h2
                                                                        ...
                                                                        You are invited as {{ $invite->role }}</h2>
                                                                    <div
                                                                        ...
                                                                        We welcome you to your new journey</div>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" valign="middle"
                                                                                ...
                                                                                <a style="color:#FFFFFF;text-decoration:none;font-family:Helvetica,Arial,sans-serif;font-size:20px;line-height:135%;"
                                                                                    href="{{ route('invites.accept', $invite->code) }}"
                                                            ...
                                                            <tr>
                                                                <td valign="top" bgcolor="#E1E1E1">
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <div>Copy this link {{ route('invites.accept', $invite->code) }} if button is not working</div>
                                                                    </div>
